...
export default function Page(){
  ...
  return <>
    <header className="header"><div className="header-inner"><div className="brand">Colheita × Fertilidade</div><div className="badge">Versão 1 · Mapa de produtividade</div></div></header>
    <main>
