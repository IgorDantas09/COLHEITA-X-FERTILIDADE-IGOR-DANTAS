...
from agrogeo import ProcessingConfig, create_yield_pdf, process_yield_map
...
app = FastAPI(title="Colheita × Fertilidade API", version="2.3.0")
app.add_middleware(
    CORSMiddleware,
...
def health():
    cleanup()
    return {"status": "ok", "version": "2.3.0-report-pdf", "temporary_ttl_minutes": TTL // 60}
